...
class MarkerServer:
    def __init__(self, host='0.0.0.0', port=5005, show_waypoints_window=False):
        ...
        self.waypoint_timeout = 60 #Release waypoint if occupied for more than 1 minute
...
class MarkerClient:
    ...
    def send_update(self,  #This function is called periodically to send the update of the client
        ...
        elif update_type =="relay marker" and marker_id is not None:
            message["type"] = "relay marker"
            message["marker_id"] = marker_id
            message["detected"] = detected
