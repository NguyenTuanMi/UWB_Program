...
def main():
  ...
  while(True):
    ...
    if retVal or ord('q') == cv2.waitKey(1) & 0xFF == ord('q'):
      break

    print("This is translation vectors", tvecs)
    print("This is rotation vectors", rvecs)
    ...
    for i, marker_id in enumerate(marker_ids):
        ...
        cv2.drawFrameAxes(frame, mtx, dst, rvecs, tvecs, 0.05)
